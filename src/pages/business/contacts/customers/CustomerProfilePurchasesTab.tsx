...
const mockPurchases: PurchaseOrder[] = [
  { 
    ...
    items: 12, 
    shippingDetails: 'Delivered to main store, dock 2',
    status: 'received', 
    paymentStatus: 'paid',
    grandTotal: 8000, 
    paidAmount: 8000,
  ...
  { 
    ...
    items: 8, 
    shippingDetails: 'Awaiting dispatch confirmation',
    status: 'partial', 
  ...
  { 
    ...
    items: 16, 
    shippingDetails: 'Received in full, goods bay 1',
    status: 'closed', 
    paymentStatus: 'paid',
    grandTotal: 13500, 
    paidAmount: 13500,
  ...
  { 
    ...
    items: 25, 
    shippingDetails: 'Scheduled for tomorrow morning',
    status: 'pending', 
  ...
  { 
    ...
    items: 5, 
    shippingDetails: 'Pickup from supplier warehouse',
    status: 'draft', 
    paymentStatus: 'unpaid',
    grandTotal: 3200, 
    paidAmount: 0,
  ...
  { 
    ...
    supplier: 'Raw Materials Inc',
    items: 30, 
    shippingDetails: 'Cancelled before dispatch',
    status: 'cancelled', 
    paymentStatus: 'unpaid',
    grandTotal: 22000, 
    paidAmount: 0,
  ...
  { 
    ...
    supplier: 'TechSupplies Ltd',
    items: 18, 
    shippingDetails: 'Delivered with priority courier',
    status: 'received', 
...
export default function SupplierProfilePurchasesTab({ supplier }: Props) {
  ...
  const handleExportCSV = () => {
    const headers = ['Date', 'Ref No', 'Location', 'Total Items', 'Shipping Details', 'Status', 'Payment Status', 'Grand Total', 'Paid', 'Due', 'Added By'];
  ...
  return (
    <div className="space-y-6">
      {/* Description */}
      <div className=" bg-gradient-to-r from-primary/5 via-transparent to-transparent p-4">
          ...
          <table className="w-full">
            <thead className="border-b border-border bg-surface-alt">
              <tr>
                ...
                <th className="px-4 py-2 text-right text-xs font-semibold text-muted-foreground whitespace-nowrap">Total Items</th>
                <th className="px-4 py-2 text-left text-xs font-semibold text-muted-foreground whitespace-nowrap">Shipping Details</th>
