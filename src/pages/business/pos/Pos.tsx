  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(15,23,42,0.12),_transparent_30%),linear-gradient(180deg,#f8fafc_0%,#f4efe6_100%)]">
      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-[1800px] flex-col gap-5 px-4 py-4 sm:px-6 lg:px-8">
        ...
        <div className="grid flex-1 gap-5 xl:grid-cols-[minmax(0,1.35fr)_minmax(360px,0.95fr)_minmax(320px,0.8fr)]">
          ...
          <aside className="flex min-h-0 flex-col gap-5 rounded-[2rem] border border-slate-200/70 bg-white/90 p-5 shadow-[0_18px_60px_rgba(15,23,42,0.08)] backdrop-blur-xl xl:sticky xl:top-4">
            <SectionTitle
              eyebrow="Payment"
              title="Close the sale"
              description="Review totals, tender payment, and finish the transaction."
              icon={CreditCard}
            />
            ...
            <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-1">
              <StatPill
                label="Grand total"
                value={`KSh ${formatMoney(grandTotal)}`}
                icon={Banknote}
              />
              <StatPill
                label="Change"
                value={`KSh ${formatMoney(changeDue)}`}
                icon={Coins}
              />
              <StatPill
                label="Payment"
              ...
              <StatPill
                label="Settings"
                value={settingsLoading ? "Loading..." : "Ready"}
                icon={Shield}
              />
            </div>
            ...
            <div className="rounded-[1.5rem] border border-slate-200 bg-slate-50 p-4">
              ...
              <div className="mt-2 flex items-center gap-3 rounded-2xl border border-slate-200 bg-white px-4 py-3">
                ...
                <input
                  ...
                  className="w-full border-0 bg-transparent text-base font-semibold text-slate-950 outline-none"
                  inputMode="decimal"
                  placeholder="0.00"
                />
              </div>
              <div className="mt-3 flex flex-wrap gap-2">
                {quickTenderAmounts.map((amount) => (
                  <button
                    ...
                    className="rounded-full border border-slate-200 bg-white px-3 py-1.5 text-xs font-medium text-slate-600 hover:border-slate-900 hover:text-slate-950"
                  >
            ...
            {!settingsLoading && settings?.hideRecentTransactions ? null : (
              <div className="rounded-[1.5rem] border border-slate-200 bg-white p-4">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-slate-500">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                type="button"
                onClick={() => toast.success("Receipt preview opened.")}
                className="inline-flex items-center justify-center gap-2 rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm font-semibold text-slate-700 hover:border-slate-900 hover:text-slate-950"
              >
              ...
              <button
                type="button"
                onClick={() => toast.success("Invoice link copied.")}
                className="inline-flex items-center justify-center gap-2 rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm font-semibold text-slate-700 hover:border-slate-900 hover:text-slate-950"
              >
            ...
            <button
              type="button"
              onClick={handleCheckout}
              className="inline-flex items-center justify-center gap-2 rounded-2xl bg-emerald-600 px-4 py-3 text-sm font-semibold text-white shadow-lg shadow-emerald-600/20 transition-colors hover:bg-emerald-500"
            >
